...
lambdaDC_bal = nCapDC*L.lambdaC_bal + nDiodeDC*L.lambdaDiode_Abal + nMosfetDC*L.lambdaMosfet_bal + ...
    nInductorDC*L.lambdaL_bal + nXfmrDC*L.lambdaXfmr_RF_bal;
lambdaDC_half_bridge = nCapDC*L.lambdaC_bal + nDiodeDC/2*L.lambdaDiode_Abal + nMosfetDC/2*L.lambdaMosfet_bal + ...
    nInductorDC*L.lambdaL_bal + nXfmrDC*L.lambdaXfmr_RF_bal;
...
lambdaPB = nCapPB*L.lambdaC_bal + nDiodePB*L.lambdaDiode_Pbal + nMosfetPB*L.lambdaMosfet_bal + ...
